...
RSpec.describe Transaction, type: :model do
  ...
  it { is_expected.to validate_numericality_of(:type).only_integer }
  ...
  it { is_expected.to validate_length_of(:company).is_at_most(14) }
  it { is_expected.to validate_length_of(:owner).is_at_most(19) }
end
